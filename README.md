...
| [`.kilocode/rules/`](.kilocode/rules) | Kilo Code assistant rules for code generation and validation. Contains guidelines for writing well-documented Python code. |
